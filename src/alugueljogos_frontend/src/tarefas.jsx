...
function tarefas() {
  ...
  async function handleSubmit(event) {
    ...
    if( idTarefa === null || idTarefa === ""){
        await alugueljogos_backend.addTarefa(descricao, categoria, false, false);            
    } else {
        await alugueljogos_backend.alterarTarefa( parseInt(idTarefa), categoria, descricao, urgente, false );    
    }
  ...
  async function alterar( id, categoria, descricao, urgente, concluida) {      
    await alugueljogos_backend.alterarTarefa( parseInt(id), categoria, descricao, urgente, concluida );    
    consultarTarefas();    
  }
